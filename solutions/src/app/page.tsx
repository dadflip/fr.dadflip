...
import SlantedSeparator from '@/components/sections/SlantedSeparator';
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="/" className="-m-1.5 p-1.5">
              ...
              <Image className="w-[150px]" src={logo} alt="Dadflip Solutions Logo" />
            </a>
          </div>
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            ...
            <a href="/flip" className="text-sm font-semibold leading-6 text-green-500">
              Flip App
            </a>
            <a href="/contact" className="text-sm font-semibold leading-6 text-green-500">
              Contact
            </a>
          </div>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-400 ring-1 ring-gray-700 hover:ring-gray-600">
              La campagne de crowdfunding pour Flip App va démarrer bientôt, on compte sur vous.
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
              Are you ready for your best adventure?
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-400">
              Nouveau ! Découvrez le monde captivant de Flip App (@flipxe) 🚀, un projet d'application révolutionnaire signé
              Dadflip Solutions 📚✨
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              >
                Soutenir le projet (indisp.)
              </a>
              <a href="/flip" className="text-sm font-semibold leading-6 text-green-500">
                Mais qu'est-ce que c'est Jamy ? <span aria-hidden="true">→</span>
              </a>
            </div>
          </div>
        </div>
